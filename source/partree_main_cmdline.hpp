#ifndef __PARTREE_MAIN_CMDLINE_HPP__
#define __PARTREE_MAIN_CMDLINE_HPP__
...
public:
  ...
  partree_main_cmdline() : input_arg(""),
  ...
  partree_main_cmdline(int argc, char *argv[]) : input_arg(""),
                                               order_arg(0), capacity_arg(0),
                                               input_given(false),
                                               order_given(false), capacity_given(false),
                                               multiple_arg(false), intersect_arg(false),
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void partree(::std::ostream &os = std::cout)
  {
...
#endif // __PARTREE_MAIN_CMDLINE_HPP__"
