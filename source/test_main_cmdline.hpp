#ifndef __TEST_MAIN_CMDLINE_HPP__
#define __TEST_MAIN_CMDLINE_HPP__
...
public:
  ...
  test_main_cmdline() : input_arg(""), tag_arg(""), tag_given(false),
  ...
  test_main_cmdline(int argc, char *argv[]) : input_arg(""), tag_arg(""), tag_given(false),
                                              minimiser_match_arg(0), capacity_arg(0),
                                              input_given(false),
                                              minimiser_match_given(false), capacity_given(false),
                                              random_arg(false), iteration_arg(0),
...
#define CHECK_ERR(type, val, which)                                                      \
  ...
  static const char *usage() { return "Usage: tree test [options] "; }
  class error
  {
    int code_;
...
#endif // __TEST_MAIN_CMDLINE_HPP__"
