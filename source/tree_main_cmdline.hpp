#ifndef __TREE_MAIN_CMDLINE_HPP__
#define __TREE_MAIN_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char *argv[])
  {
    static struct option long_options[] = {
        ...
        {"version", 0, 0, 'V'},
        {0, 0, 0, 0}};
    static const char *short_options = "hVi:o:c:C:R:dfI:q:S:L:m:T:p";
...
#define CHECK_ERR(type, val, which)                                                      \
  ...
  static const char *usage() { return "Usage: tree tree [options] "; }
  class error
  {
    int code_;
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void tree(::std::ostream &os = std::cout)
  {
