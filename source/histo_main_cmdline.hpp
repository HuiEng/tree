...
public:
  ...
  histo_main_cmdline() : bf_input_arg(""), output_arg(""),
  ...
  histo_main_cmdline(int argc, char *argv[]) : bf_input_arg(""), output_arg(""),
                                                    threshold_arg(0), window_arg(0),
                                                    element_arg(0),batch_arg(0),
                                                    bf_input_given(false), output_given(false),
                                                    threshold_given(false), window_given(false),
...
#define CHECK_ERR(type, val, which)                                                      \
  ...
  static const char *usage() { return "Usage: tree histo [options] "; }
  class error
  {
    int code_;
  ...
  {
    return "Read minimisers BF and get all-against-all Jaccard histo\n\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void histo(::std::ostream &os = std::cout)
  {
