#ifndef __MINIMISER_MAIN_CMDLINE_HPP__
#define __MINIMISER_MAIN_CMDLINE_HPP__
...
public:
  ...
  minimiser_main_cmdline() : input_arg(""), output_arg(""),
  ...
  minimiser_main_cmdline(int argc, char *argv[]) : input_arg(""), output_arg(""),
                                                   kmer_arg(0), window_arg(0),
                                                   input_given(false), output_given(false),
                                                   kmer_given(false), window_given(false),
                                                   element_given(false), multiple_arg(false),
  ...
  void parse(int argc, char *argv[])
  {
    static struct option long_options[] = {
        ...
        {"version", 0, 0, 'V'},
        {0, 0, 0, 0}};
    static const char *short_options = "hVi:o:k:w:mC";
...
#define CHECK_ERR(type, val, which)                                                      \
  ...
  {
    return "output k-mers/minimisers in string form\n\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void minimiser(::std::ostream &os = std::cout)
  {
...
#endif // __MINIMISER_MAIN_CMDLINE_HPP__"
