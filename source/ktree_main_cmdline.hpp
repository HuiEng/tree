#ifndef __KTREE_MAIN_CMDLINE_HPP__
#define __KTREE_MAIN_CMDLINE_HPP__
...
public:
  ...
  void parse(int argc, char *argv[])
  {
    static struct option long_options[] = {
        ...
        {"version", 0, 0, 'V'},
        {0, 0, 0, 0}};
    static const char *short_options = "hVi:o:c:mIs:t:";
...
#define CHECK_ERR(type, val, which)                                                      \
  ...
  static const char *usage() { return "Usage: bftree ktree [options] "; }
  class error
  {
    int code_;
  ...
  {
    return "Read minimisers BF and get all-against-all Jaccard ktree\n\n"
           "Options (default value in (), *required):\n"
           " -i, --input                              input file or folder\n"
           " -o,                                      tree order [default=10]\n"
           " -c,                                      tree capacity [default=1000000]\n"
           " -s, --specific                           read files listed in the given txt\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void ktree(::std::ostream &os = std::cout)
  {
    ...
    os << " specific_given:" << specific_given << "\t"
       << " specific_arg:" << specific_arg << "\n";
    os << " threshold_given:" << threshold_given << "\t"
       << " threshold_arg:" << threshold_arg << "\n";
  }
};
#endif // __KTREE_MAIN_CMDLINE_HPP__"
